...
class _CharityAdvertCreateState extends State<CharityAdvertCreate> {
  ...
  TextStyle style = TextStyle(color: ColorValues.greyTextColor);
      ...
      child: Column(
        ...
        children: [
          ...
          CustomDropdownWidget(
              ...
              itemList: ['Select Gender', 'Male', 'Female'],
              validator: () {}),
          SizedBox(
            height: 20,
          ),
                    ...
                    onPressed: () {
                      if (widget.id != null) {
                        charityServices.updateCharityAdvert(
                            ...
                            isPublish: false,
                            photo: puppyPhoto != null ? puppyPhoto!.path : null,
                            coverPhoto: puppyCoverPhoto != null
                                ? puppyCoverPhoto!.path
                                : null,
                            context: context);
                      } else {
        ...
        DrawerButton(
            ...
            onTap: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => CharityDashBoardScreen()));
            },
