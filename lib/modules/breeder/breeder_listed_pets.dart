...
import 'package:petbond_uk/modules/breeder/advertise_pet/advert_pet_overview.dart';
      ...
      child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("way to get paid online, to receive payments",
                  style: TextStyle(color: Colors.white)),
              SizedBox(
                height: 5,
              ),
              GestureDetector(
                ...
                child:
                    Text("click here to create or connect your Stripe account",
                        style: TextStyle(
                          color: Colors.white,
              ...
              Row(
                children: [
                  ...
                  Text("If you are ", style: TextStyle(color: Colors.white))
                ],
              ),
              SizedBox(
                height: 5,
