...
class BreederViewChat extends StatefulWidget {
  final int chatId;
  final Future<void> Function() reloadData;

  const BreederViewChat(
      {Key? key, required this.chatId, required this.reloadData})
      : super(key: key);

  @override
  State<BreederViewChat> createState() => _BreederViewChatState();
}

class _BreederViewChatState extends State<BreederViewChat> {
