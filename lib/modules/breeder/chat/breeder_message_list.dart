...
import 'package:petbond_uk/modules/breeder/chat/breeder_advert_message_list.dart';
...
class BreederMessageList extends StatefulWidget {
  const BreederMessageList({Key? key}) : super(key: key);

  @override
  State<BreederMessageList> createState() => _BreederMessageListState();
}

class _BreederMessageListState extends State<BreederMessageList> {
  ...
  Future<void> _loadDataFromAPI() async {
    List<MessageModel> message =
        await chatService.listMessages(context: context, role: 'breeder');
    setState(() {
      recentList = message;
    });
  }
