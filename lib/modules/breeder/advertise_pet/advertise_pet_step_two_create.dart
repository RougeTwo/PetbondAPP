...
import 'package:petbond_uk/modules/breeder/advertise_pet/advertise_pet_step_three.dart';
  ...
  _motherImageWidget({required SizingInformationModel sizingInformation}) {
    return Column(
      children: [
        ...
        if (mother_reports.length > 0 && mother_report_image == null)
          SizedBox(
  ...
  _fatherImageWidget({required SizingInformationModel sizingInformation}) {
    return Column(
      children: [
        ...
        if (father_reports.length > 0 && father_report_image == null)
          SizedBox(
            height: sizingInformation.safeBlockHorizontal * 7,
          ),
        if (father_reports.length > 0 && father_report_image == null)
