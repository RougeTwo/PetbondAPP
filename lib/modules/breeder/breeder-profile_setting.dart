  ...
  _assignValues() {
    if (viewModel!.detail != null) {
      ...
      if (viewModel!.detail!.local_council != null) {
        print(viewModel!.detail!.local_council);
                    ...
                    children: [
                      Text(
                        "${snapshot.data.length}" +
                            " Breeding Female Dogs added to account",
                      ...
                      ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Padding(
                              ...
                              child: Text(
                                "${microchipSummaryList[index].chip_number}" +
                                    " has had " +
                                    " ${microchipSummaryList[index].breeding_count}" +
                                    " out of 3 liters",
                                style: TextStyle(
