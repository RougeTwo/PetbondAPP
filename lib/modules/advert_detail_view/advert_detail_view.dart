            ...
            body: Container(
              ...
              child: SingleChildScrollView(
                child: Stack(
                  children: <Widget>[
                    Image(
                      image: const AssetImage(AssetValues.appBarImage),
                      fit: BoxFit.fill,
          ...
          if (advertDetailViewModel.description != null)
            Align(
              ...
              child: Text(
                ...
                style:
                const TextStyle(color: ColorValues.darkerGreyColor, fontSize: 16),
              ),
            ),
          const SizedBox(
            height: 10,
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: ColorValues.lightGreyColor.withValues(alpha: 0.4),
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              ...
              child: Column(
                children: [
                  if (advertDetailViewModel.user!.kenney_club != null)
                    Row(
                      children: [
                        Padding(
